...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/25199329542_cc08fca9bd_h.jpg");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/goose.jpg");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/GooseMed2Sprite.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/honk.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/honk2.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/honk3.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/music/uwaterlooOP.mp3");
		types.push (lime.Assets.AssetType.MUSIC);
		
		
		urls.push ("assets/sounds/Goose-SoundBible.mp3");
		types.push (lime.Assets.AssetType.MUSIC);
		
		
		urls.push ("assets/sounds/Goose-SoundBible.wav");
